...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="container">
        <div class="col-md-12 ">
            <div class="col-md-6 offset-md-3">
                @if (Route::has('login'))
                    <div class="pt-5">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline"><h3>Log in</h3></a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline"><h3>Register</h3></a>
                            @endif
                        @endauth
                    </div>
                @endif
            ...
            <div class="col-md-8 ">
                <h2>INVOICE</h2>
                <form action="{{url('invoice_store')}}"  method="POST" class="col-md-7 tab offset-md-2" enctype="multipart/form-data">
                  @csrf
